...
function LeagueInvite({ game, sender }: LeagueInviteProps) {
  return (
    <li className='flex flex-col gap-2 items-center border border-primary p-2 rounded-md text-center justify-center hover:bg-panel'>
      ...
      <span className="text-secondary font-outline-0 drop-shadow-secondary">{sender}</span> te convidou para uma <strong className="text-secondary drop-shadow-secondary">Liga</strong> de <span className="text-secondary font-outline-0 drop-shadow-secondary underline">{game}</span>.
      </div>
