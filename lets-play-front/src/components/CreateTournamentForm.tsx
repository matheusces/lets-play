    ...
    <form onKeyDown={handleKeyForm} onSubmit={handleSubmitForm} className='w-[42rem] h-[35rem] bg-form absolute z-10 left-1/4 z-1 flex flex-col gap-4 text-secondary items-center text-3xl px-12 py-10'>
      ...
      <div className='w-full h-full flex justify-between gap-2'>
        ...
        {isParticipantsManagerActive && (
          <>
            <TournamentParticipantsManager participants={participants} setParticipants={setParticipants} tournamentSize={tournamentSize} handleChangeTournamentSize={handleChangeTournamentSize} handleToggleParticipantsManager={handleToggleParticipantsManager} />
